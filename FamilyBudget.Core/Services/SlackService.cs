...
{
    public class SlackService : IService<Message>
    {
        private readonly string _token = "xoxp-316896464659-317845698950-316344801840-697ae5995e361fe3241eed85961350f5";
        ...
        public async Task Setup()
        {
            ...
            if (_familyChannel == null)
            {
                await CreateChannel("FamilyBudget").ConfigureAwait(false);
            }
        ...
        private async Task CheckFamilyChannel()
        {
            ...
            {
                _familyChannel =
                    allChannels.FirstOrDefault(x => x.Name.Equals("FamilyBudget", StringComparison.OrdinalIgnoreCase));
            }
        }
    }
}
